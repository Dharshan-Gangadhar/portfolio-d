...
// Find the start and end of the old footer section
let startIndex = lines.findIndex(line => line.includes('/* =========================') && lines[lines.indexOf(line)+1] && lines[lines.indexOf(line)+1].includes('FOOTER SECTION'));
let endIndex = lines.findIndex(line => line.includes('/* =========================') && lines[lines.indexOf(line)+1] && lines[lines.indexOf(line)+1].includes('FADE-IN ANIMATION'));
